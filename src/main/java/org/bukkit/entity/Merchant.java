...
public interface Merchant {
    ...
    /**
     * Determine if this Merchant has traded with a {@link HumanEntity} before. Trade offers are generated normally
     * only at the time this Merchant is making it's first trade; however, a Merchant may have a preexisting
     ...
     * <p>
     * This will return null if the Merchant is not trading with any HumanEntity.
    ...
    /**
     * This will construct a list of current {@link MerchantTrade}s that this Merchant
     * can offer a HumanEntity.
     * <p>
     * The returned list is unmodifiable!
     * @return an unmodifiable List of {@link MerchantTrade}s this Merchant can offer a HumanEntity.
     */
    public List<MerchantTrade> getOffers();

    /**
     * This will attempt to add a {@link MerchantTrade} that this Merchant can offer
     * a HumanEntity.
     *
     ...
     * Any active trades are not affected unless the HumanEntity exits the active trade gui.
     * @param merchantTrade trade that this Merchant needs to remove.
     * @return true if the {@link MerchantTrade} was in this Merchant's trade offer list to begin with and successfully removed
     */
